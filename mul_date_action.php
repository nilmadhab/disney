...
if(isset($_GET)){
    ...
    $table = '`multiple_date`';
    $sql = "SELECT * FROM $table WHERE `resort_id` = '$resort' and `accessibility` = '$accessible' and
     `noAdults` = '$numberOfAdults' and `noChilds` = '$numberOfChildren' and
     `start_date` = '$checkin' and  `end_date` = '$checkout' ";
