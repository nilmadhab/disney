...
//cron preprocess
$drop = "DROP TABLE `day_1`";
$rename = "RENAME TABLE `disney`.`cron_day_1` TO `disney`.`day_1`";
$create = "CREATE TABLE IF NOT EXISTS `cron_day_1` (
  `id` int(11) NOT NULL,
...
$alter1 = "ALTER TABLE `cron_day_1`
 		ADD PRIMARY KEY (`id`);";
 $alter2 = "ALTER TABLE `cron_day_1`
			...
			if($result = mysqli_query($conn,$sql))
			{
				...
				while($row = mysqli_fetch_array($result) )
				{
					...
					foreach ($links as $value) 
					{
						...
						$sql1 = "INSERT INTO `cron_day_1` ( `noAdults`, `noChilds`, `accessibility`, `resort_id`, `resort_name`, `max_adult`, `price`, `details`, `room_title`)
