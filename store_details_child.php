		...
		while($row = mysqli_fetch_array($result) )
		{
			...
			foreach ($links as $value) 
			{
				...
				$sql1 = "INSERT INTO $table ( `accessibility`,
					 `resort_id`, `resort_name`,`noofAdults`, `max_adult`, `price`, `details`, `room_title`)
				 VALUES ('$accessible','$resort','$resort_name','$numberOfAdults','$max_adult','$price','$details','$room_title')";
