	...
	while($row = mysqli_fetch_array($result))
	{
		for($cm = 0	 ; $cm < 1 ; $cm++ )
		{
			...
			foreach ($links as $value) 
			{
				...
				$price = mysqli_real_escape_string($conn,$value->find(".dualRoomPriceDetail hasComparison",0)->plaintext);
