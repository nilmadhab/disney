...
if($result = mysqli_query($conn,$sql))
{
	...
	{
		$resortcount++ ;
		if($resortcount < 6 && $resortcount > 10)
			break;
		...
		for($a = 0 ; $a < 2 ; $a++ )
		{
			...
			for($am = 1 ; $am < $processAdults ; $am++ )  
			{
				...
				{
					$childflag = true ;
					echo "==> <strong>Job2: Resort ".$resortcount." Adults ".$am." Childs ".$cm." Accessible ".$a."</strong>"."  at ".date(DATE_COOKIE,time());  
...
echo "<strong>JOB PART 2 OVER</strong> "."  at ".date(DATE_COOKIE,time())."<br>" ;
?>
