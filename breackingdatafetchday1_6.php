	...
	while($row = mysqli_fetch_array($result) )
	{
		...
		for($a = 0 ; $a < 2 ; $a++ )
		{
			...
			for($am = 1 ; $am < $processAdults ; $am++ )  
			{
				...
				{
					$childflag = true ;
					echo "==> <strong>Job6: Resort ".$resortcount." Adults ".$am." Childs ".$cm." Accessible ".$a."</strong>"."  at ".date(DATE_COOKIE,time());  
...
echo "<strong>JOB PART 6 OVER</strong> "."  at ".date(DATE_COOKIE,time())."<br>" ;
?>
